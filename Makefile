...
install: build
	...
	VER=$(VERSION); echo VERSION is $$VER; \
		mkdir -p ~/.terraform.d/plugins/${HOSTNAME}/${NAMESPACE}/${NAME}/$$VER/${OS_ARCH}; \
		mv ${BINARY} ~/.terraform.d/plugins/${HOSTNAME}/${NAMESPACE}/${NAME}/$$VER/${OS_ARCH}
